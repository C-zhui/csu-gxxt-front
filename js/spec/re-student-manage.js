require(['jquery', 'lodash', 'swal', 'api/apiobj', 'config/global', 'api/batch'], function ($, _, swal, api, g) {
  base_url = g.base_url
  ...
  // 添加新学期  或  添加新批次
  $('#addNewSemester-btn').click(addNewSemester);
  function addNewSemester() {
    ...
    api.batch.addBatch(new_semester_batch, new_semester_credit, new_semester)
      .done(function (data) {
        if (data.status === 0) {
          console.log(data);
          swal(
